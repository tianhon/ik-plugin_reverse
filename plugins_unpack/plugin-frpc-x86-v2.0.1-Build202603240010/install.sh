...
install()
{
	...
	[ -f $EXT_PLUGIN_CONFIG_DIR/$PLUGIN_NAME/frpc.ini ] || cp $INSTALL_DIR/bin/frpc.ini $EXT_PLUGIN_CONFIG_DIR/$PLUGIN_NAME/frpc.ini
	
	[ -f $INSTALL_DIR/bin/frpc ] && chmod +x $INSTALL_DIR/bin/frpc && ln -sf $INSTALL_DIR/bin/frpc /usr/bin/frpc
